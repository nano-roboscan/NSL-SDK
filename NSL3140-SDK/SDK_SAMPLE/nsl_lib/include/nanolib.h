 ...
 * @return NSL_ERROR_TYPE 
 */
NSLTOF_API NslOption::NSL_ERROR_TYPE nsl_getFrame(int handle, NslFrame *frame, int waitTimeMs = 0);
 ...
 * @return NSL_ERROR_TYPE 
 */
NSLTOF_API NslOption::NSL_ERROR_TYPE nsl_freeFrame(int handle, NslFrame *frame);
